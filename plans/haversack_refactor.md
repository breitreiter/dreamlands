---
kind: plan
title: "Haversack Refactor — Halve Slots, 1 Ration/Day"
state: superseded
created: 2026-04-07
updated: 2026-05-13
status: current
touches:
  features: [inventory, haversack, food, conditions]
provenance:
  author: migration:M-001
---
> Migration note (M-001, 2026-05-13): Not yet shipped. Coupled to spirits_economy and condition_rework — implement together or sequenced.
> **Superseded (2026-05-15)** by `inventory_consolidation.md`. The new direction removes the haversack entirely rather than halving it, and replaces single-use medicines with a reusable medical kit. Valid content from this plan (binary conditions, food model, foraging, HP model, biome ration names) is incorporated there.

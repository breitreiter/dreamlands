---
kind: plan
title: "Trade Redesign — Load System (now: Hauls)"
state: shipped
created: 2026-03-02
updated: 2026-05-13
status: current
touches:
  features: [trade, hauls, market, mapgen]
provenance:
  author: migration:M-001
---
> Migration note (M-001, 2026-05-13): Shipped as the haul system. 152 hauls now live in text/hauls/haul_catalog.md, payout formula in lib/Game/HaulDelivery.cs. The "load" terminology in this doc is the original framing; "haul" is what shipped.

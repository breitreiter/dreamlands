---
kind: plan
title: "Click-to-Move with Route Preview"
state: active
created: 2026-03-31
updated: 2026-05-13
status: current
touches:
  features: [ui, exploration, leaflet, pathfinding]
provenance:
  author: migration:M-001
---
> Migration note (M-001, 2026-05-13): tripEstimate() helper exists in ui/web/src/screens/Explore.tsx but only as a step-by-step movement helper. Click-to-destination flow not yet shipped.

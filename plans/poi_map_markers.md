---
kind: plan
title: POI Map Markers (visited settlements/dungeons on Leaflet map)
state: active
created: 2026-03-04
updated: 2026-03-04
status: current
touches:
  ...
  features: [ui, map, poi, trip-planning]
provenance:
  author: migration:M-001
---

> Migration note (M-001, 2026-05-12): Not implemented yet — no `visitedPois`
> field in GameResponse, no marker rendering in Explore.tsx. Plan is `active`
> in the sense that it's specced and ready; flip to `shipped` when the four
> file changes below land.

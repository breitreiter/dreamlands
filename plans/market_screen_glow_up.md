...
touches:
  files:
    - ui/web/src/marketNaming.ts
    - ui/web/src/screens/Market.tsx
    - ui/web/src/components/WaxSeal.tsx
  features: [ui, market, naming, wax-seals]
provenance:
...
> Migration note (M-001, 2026-05-12): All four items shipped. Verified
> `marketNaming.ts` (locale-flavored naming + seal helpers) and `WaxSeal`
> component exist; Market.tsx renders the sign-style header, byline,
> NPC-voiced subtitle, and wax seals.

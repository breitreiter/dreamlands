# Generate Haul Flavor: Deliveries to Scrub
...
- **Two recipient cultures**: The scrub has both plateau clans (honor-based, hospitality-driven, direct) and Kesharat Administration personnel (procedural, form-filing, eerily certain). Match the recipient to whichever culture makes sense for the item.

## Destination Biome: Scrub

{{INCLUDE project/reference/biome-briefs/scrub.md}}

## Examples (filled entries delivering to scrub)

# Generate Haul Flavor: Deliveries to Plains
...
- **No place names, NPC names, or landmark names.** Use roles and descriptions instead ("a heartland blacksmith", "a ridge-town cobbler").
...
## Examples (filled entries delivering to plains)

---
kind: learning
title: "Gear Gap Analysis — Reachable +6 Per Check"
created: 2026-02-22
updated: 2026-03-12
status: current
touches:
  features: [items, balance, skill-checks]
topics: [items, balance, skill-checks]
provenance:
...
| Lattice Sickness/Irradiated | Consumable (big) + equipment (small) | 0 | consumables/tools use ResistModifiers (Magnitude), not numeric bonuses |

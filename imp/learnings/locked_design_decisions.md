---
kind: learning
title: "Locked Design Decisions (early-design snapshot)"
created: 2026-02-21
updated: 2026-05-14
status: stale
touches:
  features: [design-philosophy, locked-decisions]
topics: [design-philosophy, locked-decisions, history]
provenance:
  author: migration:M-001
---
> Migration note (M-001, 2026-05-14): This is an early-design-era snapshot.
> Many of these "locked" decisions have shifted under the combat pivots and
> the haul/spirits/condition reworks (e.g., skill advancement is now "none —
> gear only", combat went d20 → RPS, .tac files were never fully adopted).
> Useful for understanding the project's original constraints; cross-check
> against current systems before acting on any specific spec here.

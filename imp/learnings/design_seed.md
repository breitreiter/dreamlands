---
kind: learning
title: "Original Game Design Seed"
created: 2026-02-21
updated: 2026-05-14
status: stale
touches:
  features: [design-philosophy, type-2-fun]
topics: [design-philosophy, type-2-fun, history, seed]
provenance:
  author: migration:M-001
---
> Migration note (M-001, 2026-05-14): Original creative brief. The
> type-2-fun framing and the trade-goods two-layer (economic + flavor)
> architecture are still north stars. Specific mechanics (combat, skill
> advancement, condition list, settlement services) have shifted under
> subsequent reworks — treat the prose here as historical context for
> design intent, not as current spec.

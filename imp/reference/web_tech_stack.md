...
touches:
  files:
    ...
    - ui/web/tailwind.config.ts
    - ui/web/src/components/ui/
  features: [tech-stack, react, shadcn, vite, figma-pipeline]
provenance:
  author: migration:M-001
subject: Why React + TypeScript + shadcn + Tailwind + Vite was chosen over Blazor/MUI/Vue/Next, and the Figma→Code pipeline
---

---
kind: reference
title: Manual Integration Test Plan (CLI vs GameServer)
created: 2026-03-04
updated: 2026-03-04
status: current
touches:
  ...
  features: [testing, integration-tests, cli]
provenance:
  author: migration:M-001
subject: Manual integration test procedures exercising encounter, movement, inventory, and market flows via the CLI client against a running GameServer. Used as the spec for the in-flight automated test harness (see TODO.md).
---

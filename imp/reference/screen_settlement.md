...
touches:
  files:
    - ui/web/src/screens/Inn.tsx
    - ui/web/src/screens/Bank.tsx
    - ui/web/src/screens/Market.tsx
  features: [ui, settlement, inn, guild, market, temple]
provenance:
  author: migration:M-001
subject: Settlement screen — town panel structure, per-building affordances (temple, inn, guild outpost, market)
---

---
kind: reference
title: Arc/Dungeon Authoring Process — LLM Pipeline
created: 2026-03-22
updated: 2026-03-22
status: current
touches:
  ...
  features: [encounter-authoring, arcs, llm-pipeline]
provenance:
  author: migration:M-001
subject: How to turn 21 dungeon/arc sketches into playable .enc chains using an LLM. Scene-type taxonomy (Intro/Bridge/Conflict/Epilogue), 3-phase pipeline (scene plan → AI draft → polish), constraint sheet, complexity tiers, per-dungeon TODO checklist.
---

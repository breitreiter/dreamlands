...
touches:
  ...
  features: [encounter-authoring, arcs]
provenance:
  author: migration:M-001
subject: How multi-scene arc encounters are structured (hubs, wings, terminals)
---

# Arc authoring guide

This guide covers structural techniques for writing multi-scene arc
encounters. It assumes you already know the .enc format (see
[[encounter_format]]) and the mechanic verbs (see [[encounter_mechanics]]).
This document is about *how to arrange scenes*, not how to write prose.

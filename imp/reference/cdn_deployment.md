---
kind: reference
title: CDN Deployment — Cloudflare R2 for Game Assets
created: 2026-03-01
updated: 2026-03-01
status: current
touches:
  files:
    - worlds/production/push.sh
    - worlds/production/build.sh
  features: [deployment, cdn, r2, asset-pipeline]
provenance:
  author: migration:M-001
subject: How static game assets (tiles, icons, portraits, equipment, vignettes) are served from Cloudflare R2
---

> Migration note (M-001, 2026-05-12): Originally titled "CDN Deployment Plan".
> The R2 sync skeleton in `worlds/production/push.sh` is live and this describes
> the current asset pipeline. Reclassified plan → reference.

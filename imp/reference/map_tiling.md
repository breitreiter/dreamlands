---
kind: reference
title: Map Tiling — Leaflet + Slippy Tiles
created: 2026-02-21
updated: 2026-02-21
status: current
touches:
  ...
  features: [map-rendering, tiles, leaflet]
provenance:
  author: migration:M-001
subject: Why Leaflet over alternatives, tile format, zoom levels, and the memory gotcha on tile slicing
---

> Migration note (M-001, 2026-05-12): Shipped. Production serves tiles via Leaflet
> at `/world/tiles/{z}/{x}/{y}`. Format is **WebP** in the live system (the spec
> below calls for PNG; WebP is a drop-in optimization). The 6-zoom-level structure
> matches the live tile pyramid.

---
kind: reference
title: Combat Monster Roster (18 sprites + lead-in flavor)
created: 2026-04-27
updated: 2026-04-27
status: current
touches:
  files:
    - assets/monsters/
  features: [combat, monsters, sprites, encounter-flavor]
provenance:
  author: migration:M-001
subject: Canonical roster of the 18 combat monsters — sprite file, biome, tier, named character, lead-in prose for the moment before engagement. Sole keeper of these intros.
---

# Monster Art Inventory

Source: `assets/monsters/`. Static PNGs, intended for the combat-screen left
panel. Each one is a candidate for a single named, hand-authored combat set
piece (one sprite = one monster).

...
touches:
  ...
  features: [ui, encounter-runner]
provenance:
  author: migration:M-001
subject: Encounter screen layout and the per-outcome flavor strings the UI displays for each mechanic
---

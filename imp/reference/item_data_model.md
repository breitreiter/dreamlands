...
touches:
  files:
    ...
    - lib/Rules/Balance.cs
    - lib/Game/ItemInstance.cs
  ...
  features: [items, inventory, market, skill-checks]
provenance:
  author: migration:M-001
subject: Two-layer item architecture (ItemDef + ItemInstance), inventory containers, skill-check gear contribution, market stock
---

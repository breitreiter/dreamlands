---
kind: reference
title: Sprite-Based Mountain Rendering (research + implementation notes)
created: 2026-02-21
updated: 2026-02-21
status: current
touches:
  files:
    - mapgen/Rendering/MountainPass.cs
    - assets/map/decals/mountains/
  features: [mapgen, rendering, mountains]
provenance:
  author: migration:M-001
subject: Techniques and asset inventory behind MountainPass — BFS distance field, height-to-sprite mapping, Y-sort, bottom-anchor, overlap. With sources.
---

> Migration note (M-001, 2026-05-12): The implementation plan in section 7 shipped
> as `mapgen/Rendering/MountainPass.cs` (242 lines): BFS distance field, scale
> ramps with height, Y-sorted bottom-anchored placement. Section 6's 49-decal
> asset inventory matches `assets/map/decals/mountains/`.

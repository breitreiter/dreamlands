---
kind: reference
title: Hiker Ranges and Settlement Spacing
created: 2026-02-21
updated: 2026-02-21
status: current
touches:
  files:
    - mapgen/SettlementPlacer.cs
    - mapgen/TierAssigner.cs
  features: [mapgen, settlement-spacing, difficulty-scaling, design-numbers]
provenance:
  author: migration:M-001
subject: Realistic travel ranges (novice + veteran), water-as-hard-limiter, settlement and POI spacing per zone. Canonical numbers behind mapgen placement.
---

...
public static class FlavorText
{
    ...
    // --- Settlements (biome, tier) ---

    public static string SettlementName(Terrain biome, int tier) =>
        $"{biome} Settlement";

    public static string SettlementDescription(Terrain biome, int tier) =>
        $"A settlement in the {biome.ToString().ToLower()}.";

    public static string GuildOfficeDescription(Terrain biome, int tier) =>
        "The guild office is open for business.";

    public static string MarketDescription(Terrain biome, int tier) =>
        "A bustling market square.";

    public static string GuildOfficeRumors(Terrain biome, int tier, string priceSheet) =>
        "No rumors today.";

    public static string TempleDescription(Terrain biome, int tier) =>
        "A quiet temple.";

    public static string InnDescription(Terrain biome, int tier) =>
        "A warm inn with a crackling fire.";

    public static string HealerDescription(Terrain biome, int tier) =>
